          ...
          <div className="md:hidden">
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <SheetContent
                ...
                className="w-80 flex flex-col border-l-[rgba(0,229,255,0.08)] bg-[linear-gradient(180deg,var(--bg-deep)_0%,var(--bg-primary)_100%)] text-[var(--text-primary)]"
              >
                ...
                <nav className="flex flex-col px-8">
                  {NAV_LINKS.map((link, i) => (
                    <Link
                      ...
                      className="block py-4 text-lg font-display font-medium tracking-wider transition-colors duration-200 hover:text-[#00e5ff]"
                      style={{
